  ...
  function result() {
    ...
    mount(`
      <section class="results page-width" data-result-status="${r.status}">
        ...
        <p class="privacy">คำตอบและคะแนนอยู่ในเครื่องนี้ และไม่ถูกส่งไปยัง Google Analytics<br>ระบบเก็บเฉพาะสถิติการใช้งานทั่วไป เช่น การเปิดหน้าและการกดปุ่ม<br>เครื่องมือนี้ไม่ใช่การวินิจฉัยด้านสุขภาพจิตหรือคำแนะนำการลงทุน</p>
      </section>`);
